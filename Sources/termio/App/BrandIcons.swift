...
enum Codicon {
    case newFile, newFolder, refresh, collapseAll, expandAll
    ...
    var subpaths: [(data: String, eoFill: Bool)] {
        ...
        case .expandAll:
            return Codicon.collapseAll.subpaths + [
                ("M7 5.5C7 5.224 7.224 5 7.5 5C7.776 5 8 5.224 8 5.5V9.5C8 9.776 7.776 10 7.5 10C7.224 10 7 9.776 7 9.5V5.5Z", false),
            ]
        case .collapseAll:
            return [
