...
Read [references/asc-submission-health/readiness-repairs.md](references/asc-submission-health/readiness-repairs.md) when diagnostics identify one of those common blockers or a first-release availability gap.

Read [references/asc-submission-health/digital-goods.md](references/asc-submission-health/digital-goods.md) only when IAP or subscription validation fails, Apple requires first-review attachment, or a versioned product must join an existing review submission.

Read [references/asc-submission-health/app-privacy.md](references/asc-submission-health/app-privacy.md) only when validation reports an App Privacy advisory or the publish state cannot be confirmed through the public API.
