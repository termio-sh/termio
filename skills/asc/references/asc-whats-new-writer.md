...
1. Read `references/asc-whats-new-writer/release_notes_guidelines.md` for tone, structure, and examples.
...
Follow the tone rules from `references/asc-whats-new-writer/release_notes_guidelines.md`:
