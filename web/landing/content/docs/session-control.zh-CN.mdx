...
x-i18n:
  ...
  source_hash: 4560c086c4f6daf3570462255476638e55d83a5140fd63576d3d5d277ee1af17
...
`termio sessions` 是[会话协议](/docs/session-protocol)其中一个平面的近路——人或 hook
会直接敲的那些 verb，而且你指的是哪个会话，它从你所在的位置替你算出来。当你需要一个
它没包的 verb，或者一条由你自己的程序持有的连接时，那一页从这一页停下的地方接着讲。
...
设备，按 **设置**——或者点 Hooks 那一行的 **重新安装**——把 hooks 装到那台机器上。这正是
